<section id="join-us" class="row" data-magellan-destination="join-us">
	...
	<ul class="medium-block-grid-2 large-block-grid-3 membership-options three-column-split">
	...
	<ul class="medium-block-grid-2 large-block-grid-3 three-column-split">
		<li><dl>
			<dt>Question</dt>
			<dd>Answer</dd>
			<dt>Question</dt>
